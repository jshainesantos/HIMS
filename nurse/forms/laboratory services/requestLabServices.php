            ...
            <div class="col-10 m-3 m-5 pt-1 mx-auto">
                ...
                <div class="card rounded-4 shadow bg-light bg-opacity-25">
                    <div class="card-body m-3">
                        ...
                        <!-- Patient Information -->
                        <h6 class="text-success mt-4">I. Patient Information</h6>
                        <div class="row mt-2">
                            <div class="col-5">
                            ...
                            <div class="col">
                                <form class="form-floating">
                                    <input type="number" class="form-control bg-light" placeholder="">
                        ...
                        <div class="row mt-2">
                            <div class="col-5">
                                <select class="form-select form-select-sm bg-light" aria-label="select example"
                                    ...
                                    <option value="3">BS-IS</option>
                                    <option value="4">Parasitology</option>
                                    <option value="5">Microbiolgy</option>
                            ...
                            <div class="col">
                                <select class="form-select form-select-sm bg-light" aria-label="select example"
                                    ...
                                    <option value="1">Set Own Time</option>
                                </select>
                            </div>
                        </div>
