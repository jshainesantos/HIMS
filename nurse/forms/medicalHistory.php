        ...
        <div class="row">
            ...
            <div class="col-10 mt-4 pt-4 mx-auto">
                ...
                <div class="card rounded-4 shadow mt-4">
                    ...
                    <div class="row overflow-auto mx-4" style="max-height: 32rem;">
                        <!-- LEFT -->
                        <div class="col-6">
                                        ...
                                        <div class="col">
                                            <div class="form-check bg-light rounded-2 py-1">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <input type="text"
                                                        class=" form-control form-control-sm border-light rounded-2 ms-2">
                                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="card my-2 bg-light inputs">
                                <div class="card-body">
                                    ...
                                    <!-- First Pregnancy -->
                                    <div class="card my-2 rounded-4 bg-success bg-opacity-10 border-secondary">
                                        <div class="card-body">
                                            <p>First Pregnancy</p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example">
                                                        <option selected>tem/pretem</option>
                                    ...
                                    <div class="upload mt-3">
                                        <div class="card-body text-success py-4"
                                            ...
                                            <p class="fs-4 text-center">Add Pregnancy</p>
                                        </div>
                                    </div>
