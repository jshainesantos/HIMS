...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-10 m-3 m-5 pt-1 mx-auto">

                <h4>Nurses Remarks</h4>
                <div class="card shadow bg-light bg-opacity-25">
                    <div class="card-body m-3">

                        <!-- Vital Signs -->
                        <h6 class="text-success mt-2">I. Vital Signs</h6>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col">
                                <form class="form-floating">
                                    <input type="text" class="form-control bg-light" placeholder="">
                                    <label for="floatingInputValue">Heart Rate</label>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            <div class="col">
                                <form class="form-floating">
                                    <input type="text" class="form-control bg-light" placeholder="">
                                    <label for="floatingInputValue">Pulse Rate</label>
                                </form>
                            </div>
                            <div class="col">
                                <form class="form-floating">
                                    <input type="text" class="form-control bg-light" placeholder="">
                                    <label for="floatingInputValue">Blood Pressure</label>
                                </form>
                            </div>
                            <div class="col">
                                <form class="form-floating">
                                    <input type="text" class="form-control bg-light" placeholder="">
                                    <label for="floatingInputValue">Respiratory Rate</label>
                                </form>
                            </div>
                            <div class="col">
                                <form class="form-floating">
                                    <input type="text" class="form-control bg-light" placeholder="">
                                    <label for="floatingInputValue">Oxygen</label>
                                </form>
                            </div>
                        </div>

                        <!-- Medications -->
                        <h6 class="text-success mt-4">II. Medications</h6>
                        <div class="row mt-2">
                            <div class="col">
                                <form class="form-floating">
                                    <input type="text" class="form-control bg-light" placeholder="">
                            ...
                            <div class="col">
                                <select class="form-select form-select-sm bg-light" aria-label="select example"
                                    style="padding-top: 18px; padding-bottom: 18px">
                                    <option selected>Shift</option>
                                    <option value="1">7:00 a.m - 3:00 p.m</option>
                                    <option value="2">3:00 p.m - 11:00 p.m</option>
                                    <option value="3">11:00 p.m - 7:00 a.m</option>
                                </select>
                            </div>
                            <div class="col">
                                <form class="form-floating">
                                    <input type="text" class="form-control bg-light" placeholder="">
                                    <label for="floatingInputValue">Medication</label>
                                </form>
                            </div>
                            <div class="col">
                                <form class="form-floating">
                        ...
                        <div class="row mt-2">
                            <div class="col">
                                <form class="form-floating">
                                    <input type="text" class="form-control bg-light" placeholder="">
                                    <label for="floatingInputValue">Treatment</label>
                                </form>
                            </div>
                            <div class="col">
                                <form class="form-floating">
                                    <input type="text" class="form-control bg-light" placeholder="">
                                    <label for="floatingInputValue">Dietary Information</label>
                                </form>
                            </div>
                        </div>

                        <!-- Notes -->
                        <h6 class="text-success mt-4">III. Notes</h6>
                        <div class="row mt-2">
                            <div class="col">
