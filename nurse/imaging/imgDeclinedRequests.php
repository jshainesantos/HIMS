            ...
            <div class="col-10  m-3 ms-5 mt-5 pt-4">
                <div class="up-table d-flex justify-content-between">
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link rounded-3  text-success" aria-current="page" href="#">
                                Send Requests
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link rounded-3 active bg-success" href="#">
                                Declined Requests
                            </a>
                        </li>
                    </ul>
                    <div class="right d-flex">
                        <form role="search">
                            <input class="form-control rounded-3" type="search" placeholder="Search"
                                aria-label="Search">
                        </form>
