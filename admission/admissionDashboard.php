            ...
            <div class="modal-content rounded-4">
              <div class="modal-body">
                <div class="modalContent m-5 row">
                  <h1 class="text-center fw-bold">Add Patient</h1>
                  <p class="text-center">Is the patient inpatient or outpatient?</p>
                  <div class="col">
                    <div class="card">
                      <div class="btn card-body bg-success bg-opacity-75 text-center">
                        <img
                          src="https://s3-alpha-sig.figma.com/img/3b64/d1ee/d09dcfced09e21c9f457285b6d4882c8?Expires=1710115200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=SzIy1H83GK8LBPJPrlBZ5KtvMi-qfk2GoktNSVoBkxNHwrUgPl-JCPQmOB00q0Y5WmEbRhx7pIt0rpMMB7aPHbHnosbDiPZcC0SAkIBV-bcfbZJYxrx~QmX7hec2JhQjHHNblRMbv4XEKGSL-NfTGGPFhp~XAnzoVUj9ijEuQ6tmFAkeA5SGTjUvAyp0oEwORAf4AtbbG~RrK3QwSQZUvLm4NswNVgozeEKlj6Wpi58d~719aT-eELpVpKW7lYfiZGvKEYzFzhcJixnGIifmFSjThV8Swn0AfICjzKVPkGToN3TaaqC99uXKj7c9LOAgWrmb0xtsTxkOYuxSbivBKw__"
                          alt="inpatient" style="height:6rem; width:6rem;">
                        <h5 class="text-light">Inpatient</h5>
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="card">
                      <div class="btn card-body bg-success bg-opacity-75 text-center">
                        <img
                          src="https://s3-alpha-sig.figma.com/img/ec7a/a049/b724586fa863035076ab9f45fc697d9c?Expires=1710115200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=qn-0tmIay0YlO097rXBZUXhGZqXm07vxxlmy8EGxSTrtrLtMiaEMMzJs2IjhCR7ugfuqnTTN~cvN9eUiXhpV3Y0rkAknxqxqcqPyHM0Y8vxeQHLpPjQ3bHZhMvcXna1ZYmobz~55Mws-C3oACy~QQALVXUyajEL8VPfe6W0fW~nrD4wONrE8RnYx~ZsGmPgbn9tfuZAbzAFxcECARfmLWFvPB07rnjdtB2o0vjjw3LKXZ5Kp~PIOZZMaa3Wj3qYEfJMEaUJiKvSSwj~Xe6CqqigD~39DuSjdsDj6xRF6MMhuuwyXdg8rM46rAKm1cOds~ncnfSzrD~xjijCAjqYfRA__"
                          alt="inpatient" style="height:6rem; width:6rem;">
                        </h1>
                        <h5 class="text-light">Outpatient</h5>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="row">
      ...
      <div class="col-3 mt-2 ps-5 pt-5">
        <div class="text-center mb-3" style="width: 18rem;">
          <div class="card-body rounded-4 py-5 bg-success bg-opacity-75">
        ...
        <div class="text-center mb-3" style="width: 18rem;">
          <div
            class="d-flex rounded-4 justify-content-evenly align-items-center card-body py-5 bg-success bg-opacity-25">
            <img
              src="https://s3-alpha-sig.figma.com/img/d2a2/fe5e/6b833d683424f7aa602691d9b12b88da?Expires=1710115200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=mLmAZ-aYFHAh7WBuOl9yRve7~C9LukmucdZxHT~SDNOPjJ0F68xkpjskUQPJBbM22Lgu9-mQfdMO4wBoeFFHX~JJEsPfpb6IVtFbnVKlVr9LOoq1YvAuzZj-wSvTNZXR4L3Q6N~NSigAstwp8V1SeDtlnEbeQFOz~LVHDBbbC1UrIfS7VcO6gxjTetAIOcwiZKqR-RLg2yB-9P3GUro7eCDHJH0rjZECHFWrDtRLjPF7Wxki-FwCivDhTYbHjy-m5MMguIfBUbLq1pddxrAmaTzqSKOMXp-r0tAC3TqCldIwNJBRCrAZxn3iyarRxd4ZR6hajbGL6~xFqt7oX5taTg__"
              alt="inpatient" style="height:7rem; width:7rem;">
        ...
        <div class="text-center mb-3" style="width: 18rem;">
          <div class="d-flex rounded-4 justify-content-evenly card-body py-5 bg-success bg-opacity-25">

            <img
              src="https://s3-alpha-sig.figma.com/img/076c/b07f/a511a12564d25b10ae9e05e69ad4f3e6?Expires=1710115200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=jIsAJGsuMXKJ9txuHtcxExzspeQK6qDEdwtWqIm~oH7hi5QX6Qr8fqepPXGPWIbnBYx4fOYeobt~Sr287MuzDywj~nf6QykyE5QLf7fYb7BYhWDOdaZkEot8TAV73PgIyZzpRI~HwKrf4L3hRRz0evBEwv8DWotiNF-r7BS1I7Rau6RavUUqlm2N4HDl8tDitIPz72xirk6DwXiBbmJTncOEZmlONxFCaq5xEiLSoduIG0NBt5JjIc3xFFbhbO1AGEHyNK2doRbFBJkKxs2Zdm8C9qhSDutC7u3f-~HplsTLCJH8iDxNb1ljDv3yijE~2M638lbVT~fuPi0TgpqVow__"
              alt="inpatient" style="height:6rem; width:6rem;">
      ...
      <div class="col-8 mt-5">
        <div class="card mt-5 pe-0 rounded-4">
          <div class="card-body m-1">
            ...
            <div class="doctors overflow-auto">
              <ul class="nav nav-underline flex-nowrap">
                ...
                <li class="nav-item">
                  <a class="nav-link text-secondary" href="#">Surgeons</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-secondary" href="#">Obstetricians and Gynecologists
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-secondary" href="#">Oncologist</a>
                </li>
              </ul>
            </div>
