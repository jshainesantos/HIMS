...
<body>
  <div class="container-fluid">
    <div class="position-absolute top-0 end-0 mt-3 me-3">
      <button class="btn btn-success ms-2">+ Add Patient</button>
      <button class="btn btn-secondary"><span class="material-symbols-outlined">notifications</span></button>
    </div>
  </div>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-3 mt-5 ps-5 pt-5">
        ...
        <div class="card text-center mb-3" style="width: 18rem;">
          <div class="card-body py-5 bg-success bg-opacity-25">
      ...
      <div class="col-8 mt-5 ">
        <div class="card mt-5 pe-0">
          <div class="card-body m-1">
            ...
            <table class="table table-striped mt-2 Add">
              <thead>
                <tr>
                  <th scope="col">ID</th>
