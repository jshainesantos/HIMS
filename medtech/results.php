                ...
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item mt-3">
                            <a class="mt-4 btn p-2 text-dark bg-opacity-25 material-symbols-outlined text-white"
                                href="#">
            ...
            <div class="col-10  m-3 ms-5 mt-5 pt-4">
                <div class="d-flex justify-content-between">
                    <ul class="nav nav-underline">
                        <li class="nav-item">
                            <a class="nav-link active text-success" aria-current="page" href="#">Chemistry</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="card rounded-4 mt-4 pe-0">
                    <div class="card-body m-1">
                        ...
                        <table class="table table-striped mt-3 Add">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row"><span class="btn text-success material-symbols-outlined">
                                            description
                                        </span></th>
