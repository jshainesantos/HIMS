        ...
        <div class="row g-2 text-center">
          <div class="col-6">
            <div class="p-1">
              <div class="py-2 btn card rounded-4 shadow bg-success bg-opacity-25">
                <div class="card-body">
                  <img class="ms-5" src="https://www.svgrepo.com/show/140213/skeleton-view-on-x-ray.svg" alt="inpatient"
                    style="height:3rem; width:3rem;">
                  <small class="float-end fw-bold text-success mx-0">15 Patients</small>
                  <p class="fw-bold pt-2">X-Ray</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-6">
            <div class="p-1">
              <div class="py-2 card rounded-4 shadow bg-light text-secondary">
                <div class="card-body">
                  <img src="https://www.svgrepo.com/show/399537/imaging-alternative-ct.svg" alt="inpatient"
                    style="height:3rem; width:3rem;">
                  <p class="fw-bold pt-2">CT-Scan</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-6">
            <div class="p-1">
              <div class="py-2 card rounded-4 shadow bg-light text-secondary">
                <div class="card-body">
                  <img src="https://www.svgrepo.com/show/482775/brain-illustration-1.svg" alt="inpatient"
                    style="height:3rem; width:3rem;">
                  <p class="fw-bold pt-2">MRI</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-6">
            <div class="p-1">
              <div class="py-2 card rounded-4 shadow bg-light text-secondary">
                <div class="card-body">
                  <img
                    src="https://s3-alpha-sig.figma.com/img/f18d/8ef3/bfa9a591c66d0679c6ee4e3e6244c52a?Expires=1710115200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=lxCtsKcuQTuS3bKD6VoBp7pdJTwffytkkoGlyqfdNvUDEmiYaXH3XreAzAHULqYvqCYaqshKdmWV~Yq0q3grNHqVmbfq9F5tNlllSjzsDtm7Rw0Jq2ArpVgkViWVn8PUquOlJduEnuJ07ObZWIjL~wCb4KO~EP9jedCdxXfqCL-jbkzZyh~iSz3galqv28uZDVgL-jOp4MtOGSpCJt2QP6LPMuW1CpT6pIeO4HhACRi6Fk4P6Kj4BtSSEKORX3Ayw-p1oLFIdUbzpIDMFbFJ-4g5jW8Qde2FcLYHxoqJroLmJoLLwcrJ5hPhb1gXlwW8IYiW~vWto7V6SZnbTudLow__"
                    alt="inpatient" style="height:3rem; width:3rem;">
                  <p class="fw-bold pt-2">Mammography</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-6">
            <div class="p-1">
              <div class="py-2 card rounded-4 shadow bg-light text-secondary">
                <div class="card-body">
                  <img src="https://www.svgrepo.com/show/279653/ultrasound.svg" alt="inpatient"
                    style="height:3rem; width:3rem;">
                  <p class="fw-bold pt-2">Sonography</p>
                </div>
              </div>
            </div>
          </div>
