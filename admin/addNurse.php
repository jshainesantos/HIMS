    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-10 mt-3 pt-4 mx-auto">
                <h4 class="fw-bold">Add Nurse</h4>
                <div class="card shadow bg-light bg-opacity-25">
                    <div class="card-body m-2">
                        <h6 class="text-success">Nurse Information</h6>
                        <div class="row mt-4">
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="card bg-light">
                                    <div class="ms-2 d-flex align-items-center">
                                        ...
                                        <div class="ms-2 right mt-3">
                                            <p class="lh-sm">Nurse-3.xls <br> <small>32.9 mb | 53% | 2 secs
                                                    left</small></p>
                                        </div>
                                    </div>
                                ...
                                <div class="card mt-3  bg-light">
                                    <div class="ms-2 d-flex align-items-center">
                                        ...
                                        <div class="ms-2 right mt-3">
                                            <p class="lh-sm">Nurse-3.xls <br> <small class="text-danger">Upload
                                                    Failed</small></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card mt-3  bg-light">
                                    <div class="ms-2 d-flex align-items-center">
                                        ...
                                        <div class="ms-2 right mt-3">
                                            <p class="lh-sm">Nurse-3.xls <br> <small>42.9 mb</small></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
