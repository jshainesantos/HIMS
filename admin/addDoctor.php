                    ...
                    <div class="card-body m-2">
                        ...
                        <div class="row mt-4">
                            <div class="col-6">
                                <form class="form-floating">
                                    <input type="text" class="form-control bg-light" placeholder="">
                                    <label for="floatingInputValue">Day and Time</label>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="card bg-light">
                                    <div class="ms-2 d-flex align-items-center">
                                        ...
                                        <div class="ms-2 right mt-3">
                                            <p class="lh-sm">Doctors-3.xls <br> <small>32.9 mb | 53% | 2 secs
                                                    left</small></p>
                                        </div>
                                    </div>
                                ...
                                <div class="card mt-3  bg-light">
                                    <div class="ms-2 d-flex align-items-center">
                                        ...
                                        <div class="ms-2 right mt-3">
                                            <p class="lh-sm">Doctors-3.xls <br> <small class="text-danger">Upload
                                                    Failed</small></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card mt-3  bg-light">
                                    <div class="ms-2 d-flex align-items-center">
                                        ...
                                        <div class="ms-2 right mt-3">
                                            <p class="lh-sm">Doctors-3.xls <br> <small>42.9 mb</small></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
